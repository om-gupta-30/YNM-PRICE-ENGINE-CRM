...
async function importAllDatabases() {
  ...
  console.log(`\n📦 Total unique accounts: ${accountMap.size}`);
  let totalContacts = 0;
  ...
  console.log(`   Found ${industries.length} industries, ${subIndustries.length} sub-industries, ${states.length} states, ${cities.length} cities`);

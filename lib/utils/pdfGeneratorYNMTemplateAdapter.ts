// Adapter to convert from existing PDFQuotationDataNew to YNMTemplatePDFData
...
import { YNMTemplatePDFData } from './pdfGeneratorYNMTemplate';
...
export function convertToYNMTemplatePDFData(data: PDFQuotationDataNew): YNMTemplatePDFData {

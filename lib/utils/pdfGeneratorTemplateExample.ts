// Example Usage of PDF Generator Template
// This file demonstrates how to use the new PDF generator

import { generateEstimatePDF, EstimatePDFData } from './pdfGeneratorTemplate';
import { generateEstimatePDFFromQuotationData } from './pdfGeneratorTemplate';
import { PDFQuotationDataNew } from './pdfGeneratorNew';

// ============================================
// EXAMPLE 1: Direct Usage with EstimatePDFData
// ============================================
export function exampleDirectUsage() {
  ...
  // PDF will download as: YNM-EST-YNM-EST-1.pdf
}
...
export async function exampleWithExistingData() {
  ...
  await generateEstimatePDFFromQuotationData(quotationData);
  // PDF will download as: YNM-EST-YNM-EST-2.pdf
}
...
export function exampleButtonHandler() {
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      // Generate PDF
      await generateEstimatePDFFromQuotationData(pdfData);

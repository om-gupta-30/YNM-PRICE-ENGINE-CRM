// Adapter to convert from existing PDFQuotationDataNew to EstimatePDFData
...
import { EstimatePDFData } from './pdfGeneratorTemplate';
...
export function convertToEstimatePDFData(data: PDFQuotationDataNew): EstimatePDFData {

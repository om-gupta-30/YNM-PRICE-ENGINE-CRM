-- ============================================
-- CLEAR ALL DATA EXCEPT USERS, STATES, AND CITIES
-- ============================================
...
BEGIN
    ...
    -- List of tables to check (excluding users, states, cities which should have data)
    FOR table_record IN 
        SELECT table_name 
    ...
    LOOP
        BEGIN
            ...
            IF table_record.table_name IN ('users', 'states', 'cities') THEN
...
-- ============================================
-- ADDITIONAL VERIFICATION (Safe - only checks existing tables)
-- ============================================
-- Check that users, states, and cities still have data:

-- =====================================================
-- FINAL COMPLETE WORKING SQL SCRIPT - NO ERRORS
-- YNM Safety CRM & Price Engine Integration
-- All column names verified: state_name, city_name, activity_type
-- =====================================================
...
BEGIN
    ...
    SELECT c.id INTO mh_mumbai_id FROM cities c WHERE c.city_name = 'Mumbai' AND c.state_id = mh_id LIMIT 1;
    SELECT c.id INTO gj_ahmedabad_id FROM cities c WHERE c.city_name = 'Ahmedabad' AND c.state_id = gj_id LIMIT 1;
    SELECT c.id INTO ka_bangalore_id FROM cities c WHERE c.city_name = 'Bangalore' AND c.state_id = ka_id LIMIT 1;
    SELECT c.id INTO dl_delhi_id FROM cities c WHERE c.city_name = 'New Delhi' AND c.state_id = dl_id LIMIT 1;
    SELECT c.id INTO ts_hyderabad_id FROM cities c WHERE c.city_name = 'Hyderabad' AND c.state_id = ts_id LIMIT 1;
    ...
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Tata Infrastructure Ltd') THEN
        ...
        VALUES ('Tata Infrastructure Ltd', 'Enterprise', 'Customer', mh_id, mh_mumbai_id, 'Rajesh Kumar', '9876543210', 'rajesh@tatainfra.com', 'Mumbai, Maharashtra', 'https://tatainfra.com', '27AABCU9603R1Z5', 'Major infrastructure client. High volume orders.', true, 0, NOW(), NOW());
    END IF;

    -- Reliance Industries
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Reliance Industries Ltd') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Reliance Industries Ltd', 'Enterprise', 'Customer', mh_id, mh_mumbai_id, 'Priya Sharma', '9876543211', 'priya@ril.com', 'Mumbai, Maharashtra', 'https://ril.com', '27AAACR1234A1Z6', 'Enterprise client. Regular orders.', true, 0, NOW(), NOW());
    END IF;

    -- Adani Group
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Adani Group') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Adani Group', 'Enterprise', 'Customer', gj_id, gj_ahmedabad_id, 'Amit Patel', '9876543212', 'amit@adani.com', 'Ahmedabad, Gujarat', 'https://adani.com', '24AABCD1234E1Z7', 'Large enterprise client.', true, 0, NOW(), NOW());
    END IF;

    -- Maharashtra Roadways
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Maharashtra Roadways Pvt Ltd') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Maharashtra Roadways Pvt Ltd', 'SMB', 'Customer', mh_id, mh_mumbai_id, 'Sanjay Mehta', '9876543213', 'sanjay@mhroadways.com', 'Mumbai, Maharashtra', NULL, '27AABCM1234F1Z8', 'Regional contractor. Good relationship.', true, 0, NOW(), NOW());
    END IF;

    -- Gujarat Construction
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Gujarat Construction Co') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Gujarat Construction Co', 'SMB', 'Prospect', gj_id, gj_ahmedabad_id, 'Deepak Shah', '9876543214', 'deepak@gujconstruct.com', 'Ahmedabad, Gujarat', NULL, '24AABCG1234H1Z9', 'New prospect. Following up.', true, 0, NOW(), NOW());
    END IF;

    -- Karnataka Builders
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Karnataka Builders') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Karnataka Builders', 'SMB', 'Onboard', ka_id, ka_bangalore_id, 'Vikram Reddy', '9876543215', 'vikram@karbuilders.com', 'Bangalore, Karnataka', NULL, '29AABCK1234I1Z0', 'Recently onboarded client.', true, 0, NOW(), NOW());
    END IF;

    -- National Highways Corp
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'National Highways Corp') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('National Highways Corp', 'Pan India', 'Customer', mh_id, mh_mumbai_id, 'Kiran Desai', '9876543216', 'kiran@nhcorp.com', 'Mumbai, Maharashtra', 'https://nhcorp.com', '27AABCN1234J1Z1', 'Pan India operations. Multiple projects.', true, 0, NOW(), NOW());
    END IF;

    -- India Infrastructure
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'India Infrastructure Pvt Ltd') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('India Infrastructure Pvt Ltd', 'Pan India', 'Retention', ka_id, ka_bangalore_id, 'Ramesh Iyer', '9876543217', 'ramesh@iipl.com', 'Bangalore, Karnataka', NULL, '29AABCI1234K1Z2', 'Requires retention efforts.', true, 0, NOW(), NOW());
    END IF;

    -- Delhi Metro
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Delhi Metro Rail Corp') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Delhi Metro Rail Corp', 'SMB', 'Customer', dl_id, dl_delhi_id, 'Suresh Gupta', '9876543218', 'suresh@dmrc.com', 'New Delhi', 'https://dmrc.com', '07AABCD1234L1Z3', 'Metro rail projects. Regular orders.', true, 0, NOW(), NOW());
    END IF;

    -- Hyderabad Construction
    IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_name = 'Hyderabad Construction') THEN
        INSERT INTO accounts (account_name, company_stage, company_tag, state_id, city_id, contact_person, phone, email, address, website, gst_number, notes, is_active, engagement_score, created_at, updated_at)
        VALUES ('Hyderabad Construction', 'SMB', 'New', ts_id, ts_hyderabad_id, 'Karthik Rao', '9876543219', 'karthik@hydconstruct.com', 'Hyderabad, Telangana', NULL, '36AABCH1234M1Z4', 'New account. Initial contact.', true, 0, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    ...
    SELECT sa.id, a.state_id, a.city_id INTO sa_id, state_id_val, city_id_val
    ...
    IF sa_id IS NOT NULL AND state_id_val IS NOT NULL AND city_id_val IS NOT NULL THEN
        IF NOT EXISTS (SELECT 1 FROM quotes_mbcb WHERE sub_account_id = sa_id AND purpose = 'Highway Construction' AND date = '2024-01-15') THEN
    ...
    IF sa_id IS NOT NULL AND state_id_val IS NOT NULL AND city_id_val IS NOT NULL THEN
        IF NOT EXISTS (SELECT 1 FROM quotes_mbcb WHERE sub_account_id = sa_id AND purpose = 'Factory Road' AND date = '2024-02-10') THEN
            INSERT INTO quotes_mbcb (section, state_id, city_id, sub_account_id, customer_name, purpose, date, quantity_rm, total_weight_per_rm, total_cost_per_rm, final_total_cost, status, created_by, is_saved, created_at, updated_at)
    ...
    IF sa_id IS NOT NULL AND state_id_val IS NOT NULL AND city_id_val IS NOT NULL THEN
        IF NOT EXISTS (SELECT 1 FROM quotes_mbcb WHERE sub_account_id = sa_id AND purpose = 'Port Access Road' AND date = '2024-03-05') THEN
            INSERT INTO quotes_mbcb (section, state_id, city_id, sub_account_id, customer_name, purpose, date, quantity_rm, total_weight_per_rm, total_cost_per_rm, final_total_cost, status, created_by, is_saved, created_at, updated_at)
...
-- =====================================================
-- STEP 8: CREATE ACTIVITIES (using activity_type, not type)
-- =====================================================
DO $$
DECLARE
    acc_id INTEGER;

        ...
        {!isViewOnlyUser && username !== 'Admin' && isQuotationConfirmed && boardSpecsConfirmed && pricingConfirmed && areaResult && costPerPiece && finalTotal && gstCalculations && (
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
            <button
              ...
              disabled={isSaving}
              className="btn-premium-gold btn-ripple btn-press btn-3d px-12 py-4 text-lg shimmer relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              style={{
                boxShadow: '0 0 20px rgba(209, 168, 90, 0.3)',
              }}
            >

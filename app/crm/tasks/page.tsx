      ...
      <div className="min-h-screen w-full px-4 py-8 relative">
        <div className="max-w-7xl mx-auto space-y-6 relative z-10">
          ...
          {isAdmin && showAnalytics && analytics && (
            <div className="bg-gradient-to-br from-slate-900/80 to-purple-900/30 rounded-2xl p-6 border border-purple-500/20 backdrop-blur-xl">
...
function CreateTaskModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4" onClick={onClose}>
      <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl border border-slate-700 p-6 w-full max-w-lg shadow-2xl" onClick={(e) => e.stopPropagation()}>
...
function UpdateStatusModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4" onClick={onClose}>
      <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl border border-slate-700 p-6 w-full max-w-md shadow-2xl" onClick={(e) => e.stopPropagation()}>
...
function StatusHistoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4" onClick={onClose}>
      <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl border border-slate-700 p-6 w-full max-w-lg shadow-2xl max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
